 ...
 */
public class Sensor extends Timed {

	/**
	 * This class helps to handle the attributon of Sensor because for
	 * transparency and instantiation. Kulon osztaly a Senzor fobb adatainak a
	...
	public static class Sensordata {
		...
		/**
		 *
		 * The final time when the Sensor send data. Az utolso ido, mikor a
		 * Sensor meg adatot fog kuldeni.
		 */
		private long lifetime;

		/**
		 * The time when the Sensor starts generating and sending data. Az az
		 * ido, mikor a Sensor elkezdi az adatgeneralast es az adatkuldest.
		 */
		private long starttime;

		/**
		 * The time when the Sensor stops generating and sending data. Az az
		 * ido, mikor a Sensor befejezi az adatgeneralast es az adatkuldest.
		 */
		...
		/**
		 * Number of the Sensor's class sensors. A Sensor szenzorjainak a szama.
		 */
		...
		/**
		 * Name ID of the Sensor. Sensor azonosito.
		 */
		private String name;
		...
		/**
		 * Getter method for data sending-generating frequency of the Sensor.
		 * Getter metodus a Sensor frekvenciajahoz.
		 */
		public long getFreq() {
			return freq;
		}
		...
		/**
		 * Getter method for the number of Sensor's class sensors. Getter metodus a
		 * Sensor szenzorainak szamahoz.
		 */
		...
		/**
		 * Constructor creates useful and necessary data for work of a Sensor.
		 * 
		 * @param lt
		 ...
		 * @param name
		 *            ID of the Sensor - Sensor azonosito
		 * @param torepo
		 ...
		 *            elott
		 */
		public Sensordata(long lt, long st, long stt, int fs, int sn, long freq, String name, String torepo,
				int ratio) {
			this.lifetime = lt;
			this.starttime = st;
			this.stoptime = stt;
		...
		public String toString() {
			return "Sensordata [lifetime=" + lifetime + ", starttime=" + starttime + ", stoptime=" + stoptime
	...
	/**
	 * It contains the all important data of the Sensor. A Sensor osszes
	...
	/**
	 * It contains the time when the Sensor start to work. Tartalmazza a
	 * szimulalt idot,amikor a Sensor elkezd mukodni.
	 */
	private long time;

	/**
	 * Necessary to organize the Sensor's repository and the cloud repository
	...
	/**
	 * True if the Sensor is working,otherwise false. Erteke igaz,ha mukodik a
	 * Sensor, egyebkent hamis
	 */
	 ...
	 * Sensor. Referencia arra a felhore, amellyel a Sensor kozos halozatban
	 * van.
	 */
	public Cloud cloud;
	...
	/**
	 * This ArrayList can contains all Sensors which we use during the
	 ...
	 * az adatmennyisegek.
	 */
	private static long[] sensorvalue;

	/**
	 * It cointains the all size of data which was generated by this Sensor. Az
	 * osszes generalt adat meretet tarolja, amit ez a Sensor generalt.
	 */
	public long generatedfilesize;

	/**
	 * It cointains the all size of data which was generated by Sensors. Az
	 * osszes generalt adat meretet tarolja, amit az osszes Sensor generalt.
	 */
	public static long allsensorsize = 0;

	/**
	 * This getter method give the main data of the Sensor. A Sensor fobb
	 * adatait tartalmazza.
	 */
	...
	/**
	 * Static getter method to reach all Sensors from everywhere. Statikus
	 * getter metodus, hogy az osszes Sensor elerheto legyen.
	 */
	 ...
	 */
	public static long[] getSensorvalue() {
		return sensorvalue;
	}
	 ...
	 * felhoazonositokat tartalmazo tombhoz.
	 */
	public static void setSensorvalue(long[] sensorvalue) {
		Sensor.sensorvalue = sensorvalue;
	}

	/**
	 * Getter method for the number of messages which was generated by the
	 * Sensor. Getter a Sensor altal aloallitott uzenetek szamahoz.
	 */
	...
	/**
	 * Getter method for the ID of cloud which belongs to this Sensor. Getter
	 * metodus a felho azonositohoz, amelyhez ez a Sensor tartozik.
	 */
	...
	/**
	 * Setter method for the ID of cloud which belongs to this Sensor. Setter
	 * metodus a felho azonositohoz, amelyhez ez a Sensor tartozik.
	 */
	...
	/**
	 * Getter method for the name of Sensor. Getter metodus a Sensor nevehez.
	 */
	 ...
	 * Sensor. Setter metodus a felhohoz, amivel a Sensor kozos halozatban
	 * van.
	 */
	...
	/**
	 * Getter method for the local repository of this sensor. Getter metodus a
	 * a Sensor lokalis repository-jahoz.
	 */
	...
	/**
	 * Setter method for the local repository of this sensor. Setter metodus a
	 * a Sensor lokalis repository-jahoz.
	 */
	 ...
	 * @param sd
	 *            the main data of the sensor - a sensor fobb tulajdonsagai
	 * @param randommetering
	 *            if true the Metering() method will be delayed - ha true, akkor
	 *            a Metering() hivas keslelteve lesz
	 * @throws NetworkException 
	 */
	public Sensor(long maxinbw, long maxoutbw, long diskbw, long reposize, final Sensordata sd,
	...
	/**
	 * This method will start the Sensor ( data generating and sending) on the
	 * given frequence. A metodus elinditja a Sensor mukodeset
	...
	/**
	 * It stops the Sensor. Used locally because the working time should depend
	 * on the Sensor lifetime/stoptime. Leallitja a Sensor mukodeset, hivasa
	 * akkor fog bekovetkezni, ha a szimulalt ido meghaladja a Sensor
	...
	/**
	 * The tick() method will be called on the frequence of Sensor. In the
	 * method was called the data generating, data sending, and it stops the
	 * Sensor when every tasks are done. A tick() metodus folyamatosan hivodik
	 * meg a beallitott frekvencianak megfeleloen. Ebben a metodusban tortenik
	 * az adatgeneralas es a fajlkuldes, vegezetul pedig a Sensor leiratkozasa
	...
	public void tick(long fires) {
		...
		// a Sensor mukodese addig amig az osszes SO el nem lett kuldve -
		// Sensors work while there are data unsent
	...
	@Override
	public String toString() {
		return "Sensor [sd=" + sd + ", repo=" + repo + ", torepo=" + torepo + ", reposize=" + reposize + ", time="
